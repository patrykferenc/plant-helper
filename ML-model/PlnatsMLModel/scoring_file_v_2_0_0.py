...
data_sample = PandasParameterType(pd.DataFrame({"N": pd.Series([0.0], dtype="float32"), "P": pd.Series([0.0], dtype="float32"), "K": pd.Series([0.0], dtype="float32"), "Temperature": pd.Series(["example_value"], dtype="object"), "Humidity": pd.Series(["example_value"], dtype="object"), "Ph": pd.Series(["example_value"], dtype="object"), "Rainfall": pd.Series(["example_value"], dtype="object")}))
